...
class QueryExecution(val sparkSession: SparkSession, val logical: LogicalPlan) {
  ...
  lazy val analyzed: LogicalPlan = {
    ...
    var originalPlan = sparkSession.sessionState.analyzer.execute(logical)
    sparkSession.sharedState.cacheManager.searchCachedData(originalPlan).getOrElse(originalPlan)
  }

  lazy val withCachedData: LogicalPlan = {
    assertAnalyzed()
    assertSupported()
    // TODO: Either return this plan or the plan generated by contains
